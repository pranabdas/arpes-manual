...
<img src={require("../static/img/manipulator-motion.webp").default} alt="manipulator-motion" width="400px" />

### Re-calibration
If the manipulator position is known, one can set it from the settings:

<img src={require("../static/img/manipulator-main-window.webp").default} alt="manipulator-main-window" width="400px" />

You can also access settings and calibration from the Setup menu.

<img src={require("../static/img/manipulator-calibration.webp").default} alt="manipulator-calibration" width="400px" />
...
<br />
<img src={require("../static/img/device-manager.webp").default} alt="device-manager.png" width="500px" />
<br/><br/>
4. Set the correct port settings:
<br />
<img src={require("../static/img/moxa-port-settings.webp").default} alt="moxa-port-settings" width="400px" />
<br/><br/>
...
<br/>
<img src={require("../static/img/manipulator-settings.webp").default} alt="manipulator-settings" width="500px" />
<br/><br/>
...
<br/>
<img src={require("../static/img/motor-speed.webp").default} alt="motor-speed" width="500px" />
<br/><br/>
...
<br/>
<img src={require("../static/img/setup-toolbar.webp").default} alt="setup-toolbar" width="500px" />
<br/><br/>
